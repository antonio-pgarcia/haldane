@ECHO OFF
TITLE ConjugationKinetics2D-v2
...
CD ConjugationKinetics2D-v2

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./ConjugationKinetics2D-v2.rs
