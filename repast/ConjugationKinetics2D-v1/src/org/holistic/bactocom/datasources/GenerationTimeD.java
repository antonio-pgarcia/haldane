 ...
 *
 */
public class GenerationTimeD implements AggregateDataSource {
		
	@Override
	public String getId() {
		return "Generation Time G(D)";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		...
		double G= (double) ModelRatesHelper.getInstance().getGenerationTimeDonors(context);
		return G;
	}
