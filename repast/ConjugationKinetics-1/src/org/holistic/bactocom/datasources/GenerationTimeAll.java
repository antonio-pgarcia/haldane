 ...
 *
 */
public class GenerationTimeAll implements AggregateDataSource {
		
	@Override
	public String getId() {
		return "Generation Time G(D+T+R)";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		...
		double G= (double) ModelRatesHelper.getInstance().getGenerationTimeAll(context);
		return G;
	}
