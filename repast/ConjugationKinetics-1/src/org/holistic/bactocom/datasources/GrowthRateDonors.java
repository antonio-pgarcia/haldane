 ...
 *
 */
public class GrowthRateDonors implements AggregateDataSource {
		
	@Override
	public String getId() {
		return "Donors growth rate";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		...
		double MU= (double) ModelRatesHelper.getInstance().getGrowthRateDonors(context);
		return MU;
	}
